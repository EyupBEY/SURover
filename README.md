...
>-1                        <t><t><t>means only publish one message and exit<br>
> /turtle1/cmd_vel         <t><t>the name of the topic to publish<br>
> geometry_msgs/Twist      <t><t>type of the message<br>
> --                       <t><t><t><t>tells the option parser that none of the following arguments is an option. This is required in cases where your arguments have a leading dash -, like negative numbers.
